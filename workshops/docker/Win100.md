...
- This returns information of all the containers running on the defualt bridge. At this point we see that our `restclient` container is assigned IP Address 172.17.0.2. We'll make some changes so that can you can ping that address from the Windows HOST.
